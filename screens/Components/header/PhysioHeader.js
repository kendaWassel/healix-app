...
const links = [
  { screen: "PhysioHome", label: t("header.home"), icon: "home-outline" },
  { screen: "PhysioNewOrders", label: t("header.newOrders"), icon: "clipboard-outline" },
  { screen: "PhysioSchedules", label: t("header.schedules"), icon: "calendar-outline" },
];
  ...
  return (
    <View style={styles.nav}>
      <TouchableOpacity onPress={() => navigation.navigate("PhysioHome")}>
      ...
      <View style={styles.rightSection}>
        ...
        <View style={styles.badge}>
          <Ionicons name="fitness-outline" size={22} color="#39CCCC" />
          <Text style={styles.badgeText}>{t("header.physio")}</Text>
        </View>
      </View>
