...
export default function AI_Medical_Assistant({ isOpen, onClose }) {
  ...
  const mapApiMessages = (apiMessages = []) =>
    [...apiMessages].reverse().map((m) => ({
      ...
      detectedSymptoms:
        Array.isArray(m.detected_symptoms) &&
        m.detected_symptoms.length
          ? m.detected_symptoms
          : null,
  ...
  const openConversation = async (id) => {
    ...
    try {
      const response = await apiFetch(
        `/api/patient/conversations/${id}/messages`
      );
      ...
      if (!response.ok) {
        setMessages([
          {
            role: "bot",
            text: t("aiAssistant.connectionError"),
            error: true,
          },
        ]);
  ...
  const sendToHealix = async (
    text,
    { isVoice = false, audioUri = null } = {}
  ) => {
    ...
    try {
      ...
      if (data.available === false) {
        setMessages((prev) => [
          ...prev,
          {
            role: "bot",
            text: t(
              "aiAssistant.serviceUnavailable"
            ),
            unavailable: true,
          },
        ]);
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          text: timedOut
            ? t(
                "aiAssistant.requestTimedOut"
              )
            : t(
                "aiAssistant.connectionError"
              ),
  ...
  try {
    ...
    if (!uri) {
      setMessages((prev) => [
        ...
        {
          role: "bot",
          text: "لم يتم الحصول على ملف التسجيل الصوتي.",
          error: true,
        },
      ]);
   ...
   *
   * IMPORTANT:
   * Android recording is MPEG-4/AAC inside M4A.
   *
   * DO NOT send it as:
   * recording.mp3
   * audio/mpeg
   *
   * because that does NOT convert the file to MP3.
   * ============================================================ */
 ...
 const sendVoiceMessage = async (uri) => {
  ...
  try {
    ...
    if (!transcribedText || transcribedText.length < 2) {
      setMessages((prev) => [
        ...
        {
          role: "bot",
          text: t("aiAssistant.noSpeechDetected"),
          error: true,
        },
      ]);
     ...
     * IMPORTANT:
     *
     * We do NOT send the audio directly to Healix chat.
     *
     * First:
     *
     * audio -> transcribe
  ...
  const synthesizeAndPlay = async (
    ...
    try {
      ...
      const response = await apiFetch(
        "/api/patient/healix-speech/synthesize",
        {
          method: "POST",
      ...
      console.error(
        "Failed to synthesize/play speech:",
        err
      );
                ...
                >
                  ...
                  {msg.isCrisis && (
                    ...
                    >
                      ...
                      <Text
                        style={
                          styles.crisisBannerText
                        }
                      >
                        {t(
                          "aiAssistant.crisisWarning"
                        )}
                      </Text>
                    </View>
                  )}
                    ...
                    !msg.unavailable && (
                      ...
                      >
                        ...
                        >
                          ...
                          i
                            ? t(
                                "aiAssistant.speaking"
                              )
                            : t(
                                "aiAssistant.playReply"
                              )}
                        </Text>
                      </TouchableOpacity>
                    )}
                  ...
                  {msg.detectedSymptoms &&
                    msg.detectedSymptoms
                      ...
                      >
                        ...
                        <View
                          style={
                            styles.symptomsChips
                          }
                        >
                          {msg.detectedSymptoms.map(
                            (
                              symptom,
                              j
                            ) => (
                  ...
                  {msg.diagnosis && (
                    ...
                    >
                      ...
                      "insufficient_information" ? (
                        <Text
                          style={
                            styles.diagnosisInsufficient
                          }
                        >
                          {t(
                            "aiAssistant.insufficientInfo"
                          )}
                        </Text>
                      ) : (
                        Array.isArray(
                        ...
                        msg.diagnosis.differential.map(
                          (d, k) => (
                            <View
                              key={k}
                              style={
                      ...
                      {msg.specialty && (
                        ...
                        >
                          ...
                          >
                            {t(
                              "aiAssistant.suggestedSpecialty"
                            )}
                            :{" "}
                            {msg.specialty}
                          </Text>
                      ...
                      {msg.patientReport && (
                        <View
                          style={
                            styles.patientReportBox
                          }
                        >
                          <Text
                            style={
                              styles.patientReportLabel
                            }
                          >
                            {t(
                              "aiAssistant.patientReportTitle"
                            )}
                          </Text>

                          <Text
                            style={
                              styles.patientReportText
                            }
                          >
                            {
                              msg.patientReport
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {c.ended_at
                            ? t(
                                "aiAssistant.completed"
                              )
                            : t(
                                "aiAssistant.inProgress"
                              )}
                        </Text>
                      </View>
                    </TouchableOpacity>
